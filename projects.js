...
// SHOW PROJECTS
{
    ...
    function conway(){
        ...
        var description = "";
        var content = "This is a Java project with an interactive GUI to play Conway's Game of Life, an automation developed by mathematician John Conway in 1970. You can manipulate the size, speed, conditions, formations, etc of the visualization.";
        displayProject(title, description, content);
    }
